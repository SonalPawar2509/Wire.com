...
public class Locators {
    ...
    public static final By CONVERSATIONS_ELEMENT = By.xpath("//*[contains(@name, 'conversation') or contains(@name, 'chat') or contains(@name, 'message')]");
    public static final By POST_LOGIN_ELEMENT = By.xpath("//*[contains(@name, 'profile') or contains(@name, 'settings') or contains(@name, 'menu')]");
    public static final By ANY_LOGIN_BUTTON = By.xpath("//XCUIElementTypeButton[contains(@name, 'Log') or contains(@name, 'Sign') or contains(@name, 'login') or contains(@name, 'Login')]");
}
